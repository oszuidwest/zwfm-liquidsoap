...
# Get deb package
wget https://github.com/savonet/liquidsoap/releases/download/rolling-release-v2.2.x/liquidsoap-e25068e_2.2.0-ubuntu-jammy-1_amd64.deb -O /tmp/liq_2.2.0_amd64.deb
