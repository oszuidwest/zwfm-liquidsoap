...
# Get deb package
wget https://github.com/savonet/liquidsoap/releases/download/rolling-release-v2.1.x/liquidsoap-f845354_2.1.4-ubuntu-jammy-1_amd64.deb -O /tmp/liq_2.1.4_amd64.deb
