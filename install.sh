...
# Get deb package
wget https://github.com/savonet/liquidsoap/releases/download/v2.1.1/liquidsoap_2.1.1-ubuntu-jammy-1_amd64.deb -O /tmp/liq221.deb

# Install deb package 
sudo apt install /tmp/liq221.deb --fix-broken
